  ...
  return (
    <div id='wrapper'>
      ...
      <div className='full'>
        ...
        <p>Welcome to DataGeeks Sports Blog! I've had the idea to make a sports blog for a while, to showcase and highlight 
          some of the most fascinating sports stories and facts out there. Unfortunately at the time, I had no 
          website creation skills, so I was forced to shelve the project. However, I've kept a list of interesting topics that I want 
          to cover, and this is the first one on that list - the insanity of Jerry Rice's career.
        </p>
        <p>In sports, there are many arguments that fans and observers use to gauge
              who is the greatest player of all time in a particular sport or category. Most arguments seem to balance a player's 
              peak performance, longevity, consistency, playoff performance, team success, and the "intangibles." These are subjective criteria; there is no "formula" to plug in a player's numbers and spit out an assessment of that player's career. 
          And in sports, two fans may have drastically different interpretations of what makes a player the "greatest of all time." And besides, 
          almost no one player in any sports conversation will satisfy all criteria set forth by an at-home analyst, so these types of conversations usually 
          produce a variety of names.
        </p>
          ...
          let alone the brutally physical wide receiver position. His career statistics tower over every other receiver's <h4>despite </h4>
          playing in a much more defense-friendly era, and the degree to which he dominated his position makes him arguably the greatest player in NFL history.
        </p>
